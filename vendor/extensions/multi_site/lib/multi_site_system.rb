module MultiSiteSystem
  def current_site
   @current_site ||= (get_site_from_request || get_site_from_session || Site.first)  # for test differnt we have to chnages here
  # @current_site ||= (get_site_from_request || get_site_from_session || Site.find(7))
  end
